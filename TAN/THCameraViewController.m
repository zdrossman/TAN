...
- (void) initializeCamera {
    ...
    //self.thenImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,40,40)];
    self.thenImageView.backgroundColor = [UIColor blueColor];
    //[self.imagePreview addSubview:self.thenImageView];
    [self.imageFeed bringSubviewToFront:self.thenImageView];
...
- (void) processImage:(UIImage *)image { //process captured image, crop, resize and rotate
    ...
    self.nowImageView = [[UIImageView alloc] initWithImage:[UIImage imageWithCGImage:imageRef]];
